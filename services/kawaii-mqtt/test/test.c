...
static int mqtt_publish_handle1(mqtt_client_t *client)
{
    ...
    return mqtt_publish(client, "/topic/test", &msg);
}
...
static void kawaii_mqtt_demo(void *parameter)
{
    ...
    mqtt_subscribe(client, "/topic/test", QOS1, sub_topic_handle1);
